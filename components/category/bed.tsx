...
export default async function BedCard({ productCount }: SofasCardProps) {
  const t = await getTranslations("Category");

  return (
    <article className="group relative grid overflow-hidden border border-[#D9C3A0] bg-white md:min-h-130 md:grid-cols-[2fr_3fr]  my-6">
      {/* Image */}
      <div className="relative aspect-4/3 md:aspect-auto  md:order-1">
        <Image
          src="/hero_image/bed.webp"
          alt={t("bed.name")}
          fill
          priority
