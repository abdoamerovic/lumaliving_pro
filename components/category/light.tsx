...
export default async function Lights({ productCount }: LightsProps) {
  const t = await getTranslations("Category");

  return (
    <article className="group relative grid border border-[#D9C3A0] bg-white md:min-h-130 md:grid-cols-[3fr_2fr] my-6">
      {/* Image */}
      <div className="relative aspect-4/3 overflow-hidden md:aspect-auto md:order-2">
        <Image
          src="/hero_image/line_light_2.avif"
          alt={t("light.name")}
          fill
          priority
